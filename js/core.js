...
var link_EricHuber = "<a href=\"https://facebook.com/fallinginlove.lywamh\" target=\"_blank\">Đình Tùngg</a>";
var i18n_map = {
  "Bongos": {
    "en": "Bongos",
    "vi": "Bongos"},
  ...
  "MEOW": {
    ...
    "vi": "Meow~"},
  "other-lang": {
    "en": "<a href=\"/?lang=ca\">Tiếng việt</a>",
    "vi": "<a href=\"/?lang=en\">English</a>"},
  "courtesy": {
    "en": "Art courtesy of "+link_StrayRogue,
    "vi": "Ảnh từ "+link_StrayRogue},
  "meme": {
    "en": "Meme by "+link_DitzyFlama,
    "vi": "Meme bởi "+link_DitzyFlama},
  "website": {
    "en": "Website by "+link_EricHuber,
    "vi": "Web bởi:"+link_EricHuber},
  "cookies": {
    "en": "This website uses cookies to analyze traffic via anonymized and aggregated data.",
    "vi": "Trang web này sử dụng cookie để phân tích lưu lượng truy cập thông qua dữ liệu tổng hợp và ẩn danh."}
};

var supportedLanguages = {"vi": true, "en": true};
